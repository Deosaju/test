...
const clientEntrypoints = [
  {
    name: 'CLIENT - Bulk-Img-Upload',
    entry: './src/client/Bulk-Img-Upload/index.js',
    filename: 'Bulk-Img-Upload', // we'll add the .html suffix to these
    template: './src/client/Bulk-Img-Upload/index.html',
  },
  {
    name: 'CLIENT - Bulk-Img-Upload-Remove-Bg',
    entry: './src/client/Bulk-Img-Upload-Remove-Bg/index.js',
    filename: 'Bulk-Img-Upload-Remove-Bg',
    template: './src/client/Bulk-Img-Upload-Remove-Bg/index.html',
  },
];
